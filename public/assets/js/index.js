...
/* harmony import */ var _transitions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);



const H = new _dogstudio_highway__WEBPACK_IMPORTED_MODULE_0__.default.Core({
    transitions: {
        default: _transitions__WEBPACK_IMPORTED_MODULE_1__.default
    }
});
...
class Fade extends _dogstudio_highway__WEBPACK_IMPORTED_MODULE_0__.default.Transition {
    in({from, to, done}){
        ...
        gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.fromTo(to.children[0], 2, { opacity: 0 }, { delay: 1.5, opacity: 1})
    }
    out({from, done}){
        done();
    }
